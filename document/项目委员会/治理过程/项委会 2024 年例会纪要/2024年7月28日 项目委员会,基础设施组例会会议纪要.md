...
1. 前情提要：[2024年7月21日 项目委员会,基础设施组例会会议纪要](https://kaiyuanshe.feishu.cn/wiki/LMxJwFausiBTmAkmTgvcG5Q1nfe)
...
### 🛠️freeCodeCamp 中文社区翻译工具

#### ✅ 输出下载 Markdown 文件的路径@罗基印

[https://github.com/freeCodeCamp-China/article-webpage-to-markdown-action/pull/28]()

#### ✅ Issue 模板从 Markdown 改为 YAML 格式@窦小波

[https://github.com/freeCodeCamp-China/article-webpage-to-markdown-action/pull/30]()

### 🛠️开源百宝箱

#### 🚧使用 slim\-docker GitHub action 瘦身 Docker 镜像@罗基印

[https://github.com/kaiyuanshe/OSS-toolbox/pull/20]()

@石垚建议在后端服务上进一步试验：

1. [GitHub \- kaiyuanshe/KYS\-service](https://github.com/kaiyuanshe/KYS-service)

2. [GitHub \- kaiyuanshe/OpenHackathon\-server: Open Hackathon Platform server v5 based on Strapi](https://github.com/kaiyuanshe/OpenHackathon-server)
...
* [x] ~~创建2024年8月4日项目委员会例会日程、会议纪要@丘儒展⏰2024-07-28 23:00~~
